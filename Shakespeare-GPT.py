...
# hyperparameters
batch_size = 64 # num of independent sequences processed in parallel
...
encode = lambda s: [stoi[c] for c in s] # encoder - take string, output ints
...
class Head(nn.Module):
    ...
    def forward(self, x):
        ...
        # perform weighted aggregation of teh values
...
class BigramLanguageModel(nn.Module):
    ...
    def generate(self, idx, max_new_tokens):
        ...
        for _ in range(max_new_tokens):
            ...
            # append sampled indx to running sequence
